...
function ObjectControls( eye , params ){
  ...
  this.distance = 300;
    var g = new THREE.IcosahedronGeometry( 2 , 2 );
    var m = new THREE.MeshBasicMaterial({color:0xffffff});
   
  this.representation = new THREE.Mesh( g, m);
...
ObjectControls.prototype.setRaycaster = function( position ){
  ...
  this.representation.position.copy( this.eye.position );
  this.representation.position.add( direction);
}
